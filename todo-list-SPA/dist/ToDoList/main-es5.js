...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(todoServices, _snackBar) {
    ...
    HomeComponent.prototype.addTodo = function (todo) {
        var _this = this;
        var obj = { todo: todo.value };
        this.todoServices.addTodo(obj).subscribe(function (res) {
    ...
    HomeComponent.prototype.getAllTodos = function () {
        var _this = this;
        this.todoServices.getAllTodos().subscribe(function (res) {
    ...
    HomeComponent.prototype.updateTodo = function () {
        this.todoServices.updateTodo(this.data).subscribe(function (res) {
            console.log(res);
        }, function (err) {
            console.log(err);
        });
    };
    HomeComponent.prototype.removeTodo = function (id) {
        var _this = this;
        if (confirm("Bu taskı silmek istediğinize emin misiniz ?")) {
            this.todoServices.removeTodo(id).subscribe(function (res) {
                console.log(res);
                _this.getAllTodos();
            }, function (err) {
                console.log(err);
...
var TodoService = /** @class */ (function () {
    ...
    TodoService.prototype.updateTodo = function (obj) {
